...
<div class="team-boxed">
    <div class="container">
        ...
        <%--                <tr>--%>
        <%--                    <td>--%>
        <%--                        <img src="https://dynaimage.cdn.cnn.com/cnn/q_auto,w_1100,c_fill,g_auto,h_619,ar_16:9/http%3A%2F%2Fcdn.cnn.com%2Fcnnnext%2Fdam%2Fassets%2F200623110902-cheddar-cubes.jpg"--%>
        <%--                                alt="cheese"--%>
        <%--                        />--%>
        <%--                    </td>--%>
        <%--                    <td>--%>
            ...
            <div class="row product-list">
                ...
                <c:forEach items="${products}" var="product">
                    <div class="gift row col-12 product-list-item">
                        <div class="gift__img col-sm-3 col-12"><img class="product-img" src="assets/img/gift_01.jpg"  alt="product image"/></div>
