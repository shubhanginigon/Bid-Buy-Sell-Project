    ...
    <div class="team-boxed">
        <div class="container">
            <div class="intro">
                ...
                <p class="text-center">On completion of this sad project, people in AIT will be able to sell their products and make multiple buyers bid on the products.</p>
            ...
            <div class="row people">
                <div class="col-md-6 col-lg-4 item">
                    <div class="box"><img class="rounded-circle" src="assets/img/1.jpg">
                        ...
                        <p class="description">Give me idea, I will turn your idea into a fully functional project. If you have a concrete idea, please drop me in my mailing address. My mailing address is suyogya.tamrakar@gmail.com</p>
                ...
                <div class="col-md-6 col-lg-4 item">
                    <div class="box"><img class="rounded-circle" src="assets/img/2.jpg">
                        ...
                        <p class="description">Experienced in Java Spring Boot Framework. I know database management and data modeling using SQL, NoSQL and Graph models. This project is going to have SQL.</p>
                        <div class="social"><a href="#"><i class="fa fa-facebook-official"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-instagram"></i></a></div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 item">
                    <div class="box"><img class="rounded-circle" src="assets/img/3.jpg" style="height: 160px;">
                        <h3 class="name">Mr. Tshering</h3>
                        <p class="title">FULL STACK WEB DEVELOPER</p>
                        <p class="description">Rooh se behti hui dhun ye ishare de<br>Kuch mere raaz tere raaz aawara se<br>Kho gaye hum kahan<br>Rangon sa ye jahan<br>Tedhe-medhe raaste hain<br></p>
                        <div class="social"><a href="#"><i class="fa fa-facebook-official"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-instagram"></i></a></div>
                    </div>
                </div>
            </div>
